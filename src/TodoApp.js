      ...
      render (){
          ...
          let main = (
              <ul className="list-group">

                {
                  todos.length > 0
                    ? <li className='list-group-item'>
                      <input type="checkbox" onChange={this.props.model.allToggle} checked={activeTodoCount === 0}/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                ...
                {
                  showTodos.map((todo,index)=><TodoItem key={index} todo={todo} toggle={this.props.model.toggle} delete={this.props.model.delete}></TodoItem>)
                }
              </ul>
          )
        return(
